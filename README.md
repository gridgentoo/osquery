...
[Реверс Инжиниринг Osquery от Facebook] для мониторинга безопасности![image](https://user-images.githubusercontent.com/31453326/187196362-ff9e8c8d-9f65-4c94-b953-4d2ccd080fdf.png)
https://drive.google.com/drive/folders/1J16q6F3XDlWBc4ny-h46qF9owbe_bgOC

Osquery предоставляет операционную систему в виде высокопроизводительной реляционной базы данных. Это позволяет вам писать запросы на основе SQL для изучения данных операционной системы. В osquery таблицы SQL представляют абстрактные понятия, такие как запущенные процессы, загруженные модули ядра, открытые сетевые подключения, плагины браузера, аппаратные события или хэши файлов.
